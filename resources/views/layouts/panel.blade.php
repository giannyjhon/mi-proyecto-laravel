...
<head>
  ...
  <meta name="author" content="Creative Tim"> <title>Sistema de Reserva de Citas | {{config('app.name')}}</title>
  <!-- Favicon -->
...
<body>
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      @include('includes.panel.siderna')
      <!-- Collapse -->
